...
export class ApiClient {
  ...
  public async buildInit(data: any): Promise<any> {
    try {
      const response = await this.axiosInstance.post('/api/v1/actions/onchain/build-init', data);
      return response.data?.data ?? response.data;
    } catch (error: any) {
      throw BentoError.fromError(error);
    }
  ...
  public async initAction(data: any): Promise<any> {
    try {
      const response = await this.axiosInstance.post('/api/v1/actions/onchain/init', data);
      return response.data?.data ?? response.data;
    } catch (error: any) {
      throw BentoError.fromError(error);
    }
  ...
  public async buildAppend(data: any): Promise<any> {
    try {
      const response = await this.axiosInstance.post('/api/v1/actions/onchain/build-append', data);
      return response.data?.data ?? response.data;
    } catch (error: any) {
      throw BentoError.fromError(error);
    }
  ...
  public async appendPayload(data: any): Promise<any> {
    try {
      const response = await this.axiosInstance.post('/api/v1/actions/onchain/append-payload', data);
      return response.data?.data ?? response.data;
    } catch (error: any) {
      throw BentoError.fromError(error);
    }
